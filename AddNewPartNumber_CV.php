<html>
<head>
<title>Add New CV Part Number</title>
...
<form action="AddNewPartNumber_CV.php" method="post">
...
<div class="container">	
		...
		<div class="two column">
			...
			<input class="u-full-width" type="text" name="plating" placeholder = "">
		</div>
</div>	
...
<?php
	...
	if(isset($_POST['submit'])){
		...
		$sql = "INSERT INTO " . $_SESSION['part_type'] . " (part_number,  size_code, diameter, thickness, material, plating, description, entered_by) 
		VALUES ('$part_number','$size_code','$diameter','$thickness','$material','$plating','$description' ,'$entered_by');";
