<html>
<head>
<title>Add New CR Part Number</title>
...
<form action="AddNewPartNumber_CR.php" method="post">
...
<?php
	...
	if(isset($_POST['submit'])){
		...
		$sql = "INSERT INTO " . $_SESSION['part_type'] . " (part_number,  size_code, description, entered_by) 
		VALUES ('$part_number','$size_code','$description' ,'$entered_by');";
