<html>
<head>
<title>Add New TF Part Number</title>
...
<form action="AddNewPartNumber_TF.php" method="post">
...
<div class="container">	
		...
		<div class="two column">
						<label for="pcb">PCB P/N:</label>
			<input class="u-full-width" type="text" name="pcb" placeholder = "">
		</div>
</div>	
...
<?php
	...
	if(isset($_POST['submit'])){
		...
		$sql = "INSERT INTO " . $_SESSION['part_type'] . " (part_number,  size_code, diameter, pcb, description, type, entered_by) 
		VALUES ('$part_number','$size_code','$diameter','$pcb','$description','$type','$entered_by');";
