<html>
<head>
<title>Add New PA Part Number</title>
...
<form action="AddNewPartNumber_PA.php" method="post">
...
<div class="container">	
		<div class="two column">
						<label for="ferrite_dia">Outer Diameter of Ferrite Disk (mm):</label>
...
<?php
	...
	if(isset($_POST['submit'])){
		...
		$sql = "INSERT INTO " . $_SESSION['part_type'] . " (part_number,  size_code, ferrite_dia, shape, entered_by) 
		VALUES ('$part_number','$size_code','$ferrite_dia','$shape','$entered_by');";
